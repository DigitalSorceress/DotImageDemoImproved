...
namespace AtalaDemos
{
    ...
    public sealed class HelperMethods
    {
        ...
        static HelperMethods()
        {
            ...
            try { _decoderImageFormats.Add(new ImageFormatInformation(new PdfDecoder() { Resolution = 300, RenderSettings = new RenderSettings() { AnnotationSettings = AnnotationRenderSettings.RenderAll } }, "PDF (*.pdf)", "*.pdf")); }
            catch (AtalasoftLicenseException) { }
